 ...
 * @author krist
 */
public class Första extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Första.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
